                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                     ...
                                     <?php if(auth()->user()->role == 'customer'): ?>
                                        <a class="dropdown-item" href="<?php echo e(route('home')); ?>">
                                            <?php echo e(__('Your order history')); ?>
                                    ...
                                    <?php if(auth()->user()->role != 'customer'): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pizza-list')): ?>
                                            <a class="dropdown-item" href="<?php echo e(route('pizzaapp.index')); ?>">
                                                <?php echo e(__('View pizza')); ?>
...
<?php /**PATH H:\webBack\xamppro\htdocs\supermarket\resources\views/layouts/app.blade.php ENDPATH**/ ?>